...
const outputOptions: OutputOptions[] = [
  {
    ...commonOutputOptions,
    format: 'cjs',
    file: resolvePath('../dist/mock-xmlhttprequest.cjs'),
  },
  {
    ...commonOutputOptions,
    format: 'cjs',
    ...
    exports: 'auto', // Gets rid of a warning. All exports from index are named so we're fine.
  },
  {
    ...commonOutputOptions,
    format: 'es',
    file: resolvePath('../dist/mock-xmlhttprequest.mjs'),
  },
  {
    ...commonOutputOptions,
    format: 'es',
