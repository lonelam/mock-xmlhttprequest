...
// Rules for both TypeScript and JavaScript
const commonRules = {
  ...
  // 'spaced-comment': [baseRules['spaced-comment'][0], baseRules['spaced-comment'][1], {
  //   ...baseRules['spaced-comment'][2],
  //   line: {
  //     ...baseRules['spaced-comment'][2].line,
  //     exceptions: [...baseRules['spaced-comment'][2].line.exceptions, '/']
  //   },
  // }],
};
